...
public:
    WindowMorse(QWidget* parent = 0) : QWidget(parent) {
        ...
        // TODO add all the GPIO pins !!this is BETA
        ...
        morseWinLineEdit->setInputMask(">aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"); //    TODO set as per say 150 chars
...
private:
    // TODO map of all the gpios !!thi is BETA
